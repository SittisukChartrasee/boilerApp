...
export default class App extends React.Component {
  ...
  reverseOpacity = this.coverScale.interpolate({
    inputRange: [0, 0.5, 1],
    outputRange: [0, 0.15, 1],
    extrapolate: 'clamp',
  });
  // radium = this.coverScale.interpolate({
  //   inputRange: [0, 0.5, 1],
  //   outputRange: [1, 0.15, 0],
  //   extrapolate: 'clamp',
  // })
          ...
          >
            ...
            >
              <Animated.View style={styles.shadowContainer}>
                <View style={[styles.innerShadow, { borderRadius: !this.state.scrollDisabled ? 10 : 0 }]}>
                  <Animated.Image
                    style={[
                      styles.coverImage,
                      {
